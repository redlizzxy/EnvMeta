# Liu2023_coldseep_stress_hypothesis — Stress Hypothesis Score

- overall_score: **0.625**
- label: **SUGGESTIVE**
- n_satisfied / n_total / n_skipped: 2 / 3 / 1
...
|---|---|---|---|---|
| as_oxidation_should_dominate_stress_A | pathway_active | satisfied | 1.00 | 1.5 |
...
- evidence: `{'pathway_id': 'Arsenite oxidation', 'element': 'arsenic', 'n_active_mags': 2, 'mean_completeness': 50.0, 'total_contribution': 0.3}`
- evaluator note: Arsenite oxidation: 2 个 MAG 活跃，平均完整度 50%，总贡献 0.3
...
- evidence: `{'pathway_id': 'Arsenate reduction', 'element': 'arsenic', 'n_active_mags': 18, 'mean_completeness': 50.0, 'total_contribution': 6.43, 'max_completeness_threshold': 50.0}`
