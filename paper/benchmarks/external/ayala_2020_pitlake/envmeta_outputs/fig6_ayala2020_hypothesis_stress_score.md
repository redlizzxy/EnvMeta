# Ayala2020_pitlake_deep_stress_hypothesis — Stress Hypothesis Score

- overall_score: **0.455**
- label: **SUGGESTIVE**
- n_satisfied / n_total / n_skipped: 2 / 4 / 0
...
|---|---|---|---|---|
| sulfide_oxidation_should_dominate_stress_A | pathway_active | satisfied | 1.00 | 1.5 |
...
- status=unsatisfied score=0.00 weight=1.5
- evidence: `{'pathway_id': 'Dissim. sulfate red.', 'element': 'sulfur', 'n_active_mags': 8, 'mean_completeness': 84.38, 'total_contribution': 675.0, 'max_completeness_threshold': 50.0}`
